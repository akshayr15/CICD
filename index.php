                ...
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <?php if (isset($_SESSION['username'])) : ?>
                            <h4 style="color: white;margin-top: 3px;">Welcome <strong><?php echo $_SESSION['username']; ?></strong></h4>


                            <li class="scroll-to-section"><a href="#top" class="active">Home</a></li>
                            <li class="scroll-to-section"><a href="#features">About</a></li>
                            <li class="scroll-to-section"><a href="#our-classes">Classes</a></li>
                            <li class="scroll-to-section"> <a href="index.php?logout='1'" style="color: red;">logout</li>
                            </p>
                        <?php endif ?>
                        <a href="http://localhost:8090/CICD/register.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Signup</a>
                    </ul>
